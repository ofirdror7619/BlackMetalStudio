    ...
    <>
      <main className={`page ${bodyFont.className}`} onPointerMove={handlePointerMove} onPointerLeave={handlePointerLeave}>
        ...
        <section className="panel">
          ...
          <label className="stormToggle">
            <input type="checkbox" checked={stormMode} onChange={e => setStormMode(e.target.checked)} />
            <span>Storm Mode</span>
          </label>
          <button onClick={generate}>Generate Black Metal Song</button>
        </section>
        <div className={`storm ${stormMode ? "active" : ""}`} aria-hidden="true">
          <div className="rainLayer rainA" />
          <div className="rainLayer rainB" />
          <div className="stormNoise" />
        </div>
      </main>
      ...
      <style jsx>{`
        ...
        .stormToggle span {
          text-shadow: 0 0 8px rgba(136, 28, 28, 0.32);
        }
        ...
        .rainA {
          background-image: repeating-linear-gradient(180deg, rgba(170, 180, 210, 0.55) 0 10px, transparent 10px 22px);
          transform: skewX(-10deg);
        }

        .rainB {
          background-image: repeating-linear-gradient(180deg, rgba(110, 130, 170, 0.45) 0 8px, transparent 8px 20px);
        ...
        @keyframes rainFall {
          0% {
            transform: translateY(-16%) skewX(-12deg);
          }
          100% {
            transform: translateY(16%) skewX(-12deg);
          }
